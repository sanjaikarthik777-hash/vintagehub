        ...
        <div className="flex flex-col h-full bg-white border-r border-gray-200">
            ...
            <div className="flex-1 overflow-y-auto py-6">
                <nav className="space-y-2 px-4">
                    ...
                    <NavLink to="/shop?tags=Trending" onClick={() => setMobileOpen(false)} className={() => `flex items-center gap-3 px-4 py-3 rounded-lg font-bold transition-colors ${location.search.includes('Trending') ? 'bg-orange-50 text-orange-600' : 'text-orange-500 hover:bg-orange-50'}`}>
